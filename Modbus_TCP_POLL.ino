...
IPAddress server(192, 168, 33, 60); // update with the IP Address of your Modbus server
...
//    }
  Serial.println("T&H");
  float sensor_data = modbusTCPClient.holdingRegisterRead(1,1);
  Serial.println(sensor_data);
  //delay(100);
  float sensor_data1 = modbusTCPClient.holdingRegisterRead(1,2);
  Serial.println(sensor_data1);
  Serial.println("Co2");
  //delay(100);
  float sensor_data2 = modbusTCPClient.holdingRegisterRead(2,1);
  Serial.println(sensor_data2);
  //delay(100);

  // L& T 
 Serial.println("L&T Wh");
  float data3=modbusTCPClient.holdingRegisterReadFloat(3,158);
